...
class WPML_TM_Dashboard_Display_Filter {
	...
	private function display_button() {
		$reset_url = $this->get_admin_page_url( array( 'page' => WPML_TM_FOLDER . '/menu/class.main.php', 'sm' => 'dashboard', 'action' => 'reset' ) );
		?>
	...
	public function display() {
		$form_url = $this->get_admin_page_url( array( 'page' => WPML_TM_FOLDER . '/menu/class.main.php', 'sm' => 'dashboard' ) );
		?>
