...
class TranslationManagement {
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		switch ( $submenu ) {
			case 'jobs':
				...
				wp_register_script( 'headjs', ICL_PLUGIN_URL . '/res/lib/head.min.js', array(), false, true );
				$paths['core'] = ICL_PLUGIN_URL . '/res/js/';
				if ( defined( 'WPML_TM_URL' ) ) {
					$paths['tm'] = WPML_TM_URL . '/res/js/';
				}
				wp_localize_script( 'headjs', 'WPML_headjs', array( 'path' => $paths ) );
	...
	function process_request($data){
		...
		switch( $action ){
			...
			case 'dashboard_filter':
				...
				wp_safe_redirect( 'admin.php?page=' . WPML_TM_FOLDER . '/menu/class.main.php&sm=dashboard' );
				break;
			case 'sort':
			...
			case 'jobs_filter':
				...
				wp_safe_redirect( 'admin.php?page=' . WPML_TM_FOLDER . '/menu/class.main.php&sm=jobs' );
				break;
			case 'ujobs_filter':
	...
	public static function get_translator_edit_url( $translator_id ) {
		...
		if ( ! empty( $translator_id ) ) {
			$url = 'admin.php?page=' . WPML_TM_FOLDER . '/menu/class.main.php&amp;sm=translators&icl_tm_action=edit&amp;user_id=' . $translator_id;
		}
