...
class WCML_Dependencies {
	...
	private function check_for_incompatible_permalinks() {
		...
		$message .= ' | ';
		$message .= '<a href="' . admin_url( 'admin.php?page=' . WPML_TM_FOLDER . '/menu/class.main.php&sm=mcsetup#icl_custom_posts_sync_options' ) . '">' . __( 'Configure products slug translation', 'woocommerce-multilingual' ) . '</a>';
