...
class WPML_Package_Translation_Metabox {
	...
	public function __construct( $package, $wpdb, $sitepress, $args = array() ) {
		...
		if ( $this->got_package() ) {
			$this->dashboard_link = admin_url( 'admin.php?page=' . WPML_TM_FOLDER . '/menu/class.main.php&sm=dashboard&type=' . $this->package->kind_slug . '&lang=' . $this->package->get_package_language() );
