<?php
    ...
    use markmarushak\curlapi\Response;
    ...
    class Curl implements TransportInterface
    {
         ...
         * @var string Api url
         */
        protected $url = "https://mymst.myers-stevens.com/api/";
        ...
        public function getToken()
        {
            ...
            if (isset($response->getData()->access_token)) {
                $this->client->auth->setToken($response->getData()->access_token);
            } else {
