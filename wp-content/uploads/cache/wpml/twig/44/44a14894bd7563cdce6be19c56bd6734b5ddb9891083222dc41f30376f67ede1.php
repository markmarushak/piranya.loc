...
/* custom-prices.twig */
class __TwigTemplate_3d178f8b8a9e1c05a8931a267280a850426d17866e5b64837d18f34a93c2d4c5 extends Twig_Template
{
...
<div class=\"wcml_custom_prices_block\">
    ";
        ...
        if (twig_test_empty(($context["currencies"] ?? null))) {
            ...
            <label>";
            // line 8
            echo $this->getAttribute(($context["strings"] ?? null), "not_set", array());
            echo "</label>
        </div>
    ";
        } else {
            ...
            echo " />
                ";
            // line 15
            echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "calc_auto", array()), "html", null, true);
            echo "&nbsp;
            ...
            // line 17
            echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "see_prices", array()));
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "show", array()), "html", null, true);
            echo "</a>
            ...
            echo " />
                ";
            // line 25
            echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "set_manually", array()), "html", null, true);
            echo "
            </label>
            ...
            echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "enter_prices", array()), "html", null, true);
            echo "</a>
                <a style=\"display:none\" href=\"\" class=\"wcml_custom_prices_manually_block_hide\">- ";
            // line 29
            echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "hide_prices", array()), "html", null, true);
            echo "</a>
            </div>
        </div>
        ...
        <div class=\"wcml_custom_prices_manually_block\" ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["currency"]) {
                ...
                if (twig_test_empty($this->getAttribute($this->getAttribute($context["currency"], "custom_price", array()), "_regular_price", array(), "array"))) {
                    ...
                    echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "det_auto", array()), "html", null, true);
                    echo "</span>
                    ";
                }
                // line 43
                ...
                if (($context["is_variation"] ?? null)) {
                    ...
                    foreach ($context['_seq'] as $context["key"] => $context["custom_price"]) {
                        ...
                        echo "                            <p>
                                <label>";
                        // line 47
                        echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), $context["key"], array(), "array"), "html", null, true);
                        echo " ( ";
                ...
                echo "
                    <div class=\"wcml_schedule\">
                        <label>";
                // line 61
                echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "schedule", array()), "html", null, true);
                echo "</label>
                ...
                echo " />
                                ";
                // line 70
                echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "same_as_def", array()), "html", null, true);
                echo "
                            </label>
                ...
                echo " />
                                ";
                // line 79
                echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "set_dates", array()), "html", null, true);
                echo "
                                <span class=\"block_actions\">(
                ...
                // line 82
                echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "collapse", array()), "html", null, true);
                echo "</a>
                                )</span>
                            </label>
                ...
                echo "\"
                                       placeholder=\"";
                // line 91
                echo $this->getAttribute(($context["strings"] ?? null), "from", array());
                echo " YYYY-MM-DD\"
                ...
                echo "\"
                                       placeholder=\"";
                // line 98
                echo $this->getAttribute(($context["strings"] ?? null), "to", array());
                echo "  YYYY-MM-DD\"
                                       maxlength=\"10\" pattern=\"[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])\" />
    ...
    ";
        ...
        if (twig_test_empty(($context["is_variation"] ?? null))) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "enter_price", array()), "html", null, true);
            echo "</div>
    ";
        }
        // line 137
...
";
    ...
    {
        return new Twig_Source("", "custom-prices.twig", "E:\\OSPanel\\domains\\pirany.loc\\wp-content\\plugins\\woocommerce-multilingual\\templates\\multi-currency\\custom-prices.twig");
    }
}
